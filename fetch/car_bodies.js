        ...
        this.innerHTML = `
            ...
            <div class="row row-cols-3 row-cols-md-6 g-4 mt-3 justify-content-center align-items-center">
                <div class="brand kasa-card">
                  <a href="kasatipleri.html#sedan" class="brand-link"> 
                ...
                <div class="brand kasa-card">
                  <a href="kasatipleri.html#hb" class="brand-link"> 
                    <div class="card h-100 d-flex flex-column align-items-center">
                ...
                <div class="brand kasa-card">
                  <a href="kasatipleri.html#suv" class="brand-link"> 
                    <div class="card h-100 d-flex flex-column align-items-center">
                ...
                <div class="brand kasa-card">
                  <a href="kasatipleri.html#cabrio" class="brand-link"> 
                    <div class="card h-100 d-flex flex-column align-items-center">
                ...
                <div class="brand kasa-card">
                  <a href="kasatipleri.html#minivan" class="brand-link"> 
                    <div class="card h-100 d-flex flex-column align-items-center">
                ...
                <div class="brand kasa-card">
                  <a href="kasatipleri.html#pickup" class="brand-link"> 
                    <div class="card h-100 d-flex flex-column align-items-center">
